...
## Project Structure
    ...
    ├── testapiautosetting_127227  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127227`
...
2. Clone this repo and `cd testapiautosetting_127227`
